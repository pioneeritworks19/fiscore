...
part 'features/auth/email_link_completion_screen.dart';
...
part 'features/actions/action_inbox_screen.dart';
part 'features/audits/internal_audits_screen.dart';
part 'features/audits/internal_audit_library_screen.dart';
part 'features/audits/internal_audit_session_screen.dart';
part 'features/audits/internal_audit_review_screen.dart';
part 'features/audits/internal_audit_assignment_sheet.dart';
part 'features/audits/audits_screen.dart';
part 'features/violations/violation_list_row.dart';
...
part 'features/shell/team_management_screen.dart';
part 'features/auth/invite_acceptance_screen.dart';
...
part 'data/repositories/team_repository.dart';
...
part 'data/repositories/internal_audit_repository.dart';
part 'data/repositories/violation_repository.dart';
part 'data/repositories/training_repository.dart';
part 'data/repositories/action_item_repository.dart';
part 'services/violation_media_service.dart';
part 'services/audit_media_service.dart';
